...
- dimension: one of "career", "social", "wealth", "vitality", "mind", "love", "family" — infer from context:
  ...
  - wealth: money, savings, investments, budget, expenses, salary, flights, travel bookings, paying bills, financial transactions
  - vitality: exercise, workout, gym, sleep, eating, health, energy, steps, walk, run, beauty treatments, medical appointments
  ...
  IMPORTANT: always assign a dimension — never return null for dimension. Make your best guess.
...
If multiple tasks are detected, populate the "tasks" array with ALL of them (same fields as above for each). Also set "task" to the first item in the array for backward compatibility.
