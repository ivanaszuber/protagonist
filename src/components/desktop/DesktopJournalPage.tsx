        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ ...font, color: 'rgba(255,255,255,0.6)', fontSize: 11.5, fontStyle: 'italic', lineHeight: 1.55, textAlign: 'center', marginBottom: 14 }}>
              &ldquo;Your story is always being written. I&apos;m here to help you read it.&rdquo;
            </div>

            <button
              type="button"
              onClick={() => openOracle()}
              style={{ ...font, width: '100%', background: 'transparent', color: 'rgba(255,255,255,0.75)', padding: 9, borderRadius: 8, fontSize: 12, fontWeight: 500, border: '1.5px solid rgba(255,255,255,0.2)', cursor: 'pointer', transition: 'border-color 0.15s' }}
            >
              Chat with Oracle →
            </button>
          </div>
